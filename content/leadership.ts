...
export const LEADERSHIP_ROLES: LeadershipRole[] = [
  ...
  },
  {
    ...
    description:
      "Helped steer the Science and Technology Club through a formative period — keeping operations tight, members engaged, and the club's vision pointed toward what students actually needed.",
    impact: [
  ...
  },
  {
    ...
    description:
      'Stepped into a lab coordination role in the very first year of college — keeping resources running, students engaged, and IoT projects moving forward before most peers had found their footing.',
    impact: [
  ...
  },
  {
    ...
    description:
      'Served as a core technical backbone for Aarohan 2022 — keeping AV, software, and networking running flawlessly so the event could focus on what mattered: the participants.',
    impact: [
  ...
  },
  {
    ...
    period: 'Oct 2022',
    description:
      "Contributed as a student volunteer to one of Rajasthan's flagship investment summits — supporting the administrative machinery that kept a large-scale government event running smoothly.",
    impact: [
...
export const LEADERSHIP_ICON_MAP = {
  users: Users,
  trophy: Trophy,
  star: Star,
}
